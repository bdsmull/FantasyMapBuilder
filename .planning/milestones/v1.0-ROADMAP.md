...
**Plans**: 4 plans
  ...
  - [x] 05-02-PLAN.md — Extend WorldSetDialog with edit-mode props (initialView/initialParentMapName/initialMapName) for context menu wiring (PANEL-04)
  - [x] 05-03-PLAN.md — WorldHierarchyPanel component: tree render, collapse, dirty-guard navigation, context menu, warning badges (PANEL-01..05)
...
**Plans**: 4 plans
  ...
  - [x] 06-02-PLAN.md — MapCanvas.tsx integration: hover, click-to-navigate, touch two-tap, overlap picker
  - [x] 06-03-PLAN.md — StatusBar.tsx parent breadcrumb with click navigation
...
**Plans**: 3 plans
  ...
  - [x] 07-03-PLAN.md — Vitest coverage: canvasContextMenu.test.ts + worldSetDialog Phase 7 contracts (CTX-01..CTX-04)
**UI hint**: yes
